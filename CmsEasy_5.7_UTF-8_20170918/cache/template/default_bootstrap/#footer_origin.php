...
<div class=" col-xs-12 col-sm-6 col-md-4 col-lg-4 fweixin" style="float: right;">
<div class="row">
...
<p><div id="qrcode"></div><img src="<?php echo get(weixin_pic);?>" onerror='this.src="<?php echo config::get('onerror_pic');?>"' /></p>
    <p style="display: none;"><?php echo lang(scanning);?><?php echo lang(access);?><br><?php echo lang(sitewap);?></p>
    <p>关注<br>官方订阅号</p>
<?php } ?>
</div>
<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
...
<div class="copyright">
<p>
    <!--<?php echo get(site_right);?><a href="<?php echo get(site_url);?>" target="_blank"><?php echo get(fullname);?></a> &nbsp;版权所有&nbsp;<a href="<?php echo $base_url;?>/sitemap.html" target="_blank"><?php echo lang(sitemap);?></a>&nbsp;&nbsp;<a rel="nofollow" href="http://www.miibeian.gov.cn/" rel="nofollow" target="_blank"><?php echo get('site_icp');?></a>-->
    <?php echo get(site_right);?><a><?php echo get(fullname);?></a> &nbsp;版权所有&nbsp;&nbsp;<a rel="nofollow" href="http://www.miibeian.gov.cn/" rel="nofollow" target="_blank"><?php echo get('site_icp');?></a>
</p>
<p>
...
<div class="home-links" style="display: none;">
<div class="hr"></div>
<div class="container">
<div class="row">

...
?>
<div>
<h3><a title="<?php echo lang('guestbook');?>" href="#"><?php echo lang('guestbook');?></a></h3></div>
<?php
}elseif(front::get('case') == 'comment'){
?>
<div>
<h3><a title="<?php echo $t['name'];?>" href="<?php echo $t['url'];?>"><?php echo lang('commentlist');?></a></h3></div>
<?php
}elseif(front::get('case') == 'type'){
?>
<div>
<h3><?php echo type::getpositionhtml($type['typeid']);?></h3></div>
<?php
}elseif(front::get('case') == 'special'){
?>
<div>
<h3><a title="<?php echo $special['title'];?>" href="#"><?php echo $special['title'];?></a></h3></div>
<?php
}elseif(front::get('case') == 'tag'){
?>
<div>
<h3><a title="<?php echo $tag;?>" href="#"><?php echo $tag;?></a></h3></div>
<?php
...
<?php foreach(position($catid) as $t) { ?>

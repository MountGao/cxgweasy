...
<li class="active"><a href="<?php echo $base_url;?>/index.php?case=database&act=phpwebinsert&admin_dir=<?php echo get('admin_dir');?>&site=default">导入PHPweb数据</a></li>
...
<?php echo form::input('phpweb_prefix');?>
...
<div class="col-xs-8 col-sm-7 col-md-7 col-lg-5 text-left">
<?php echo form::upload_file('data','data');?>

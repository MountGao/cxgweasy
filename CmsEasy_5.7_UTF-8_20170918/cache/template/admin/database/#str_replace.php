...
<li class="active"><a href="<?php echo $base_url;?>/index.php?case=database&act=str_replace&admin_dir=<?php echo get('admin_dir');?>&site=default">替换字符串</a></li>
...
<?php echo form::select('stable',0,$tables,'style="font-size:12px"');?>
</div>
</div>
...
<div class="col-xs-8 col-sm-7 col-md-7 col-lg-5 text-left">
<?php echo form::textarea('replace1','','cols="50" rows="3"');?>
</div>
</div>
<div class="clearfix blank20"></div>
...
<div class="col-xs-8 col-sm-7 col-md-7 col-lg-5 text-left">
<?php echo form::textarea('replace2','','cols="50" rows="3"');?>
</div>
</div>
<div class="clearfix blank20"></div>
...
<div class="col-xs-8 col-sm-7 col-md-7 col-lg-5 text-left">
<?php echo form::input('where','','size="60"');?></div>
</div>

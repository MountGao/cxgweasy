...
<li class="active"><a href="<?php echo $base_url;?>/index.php?case=database&act=baker&admin_dir=<?php echo get('admin_dir');?>&site=default">备份数据库</a></li>
...
<tbody>
        <?php foreach(tdatabase::getInstance()->getTables() as $table) { ?>
      <tr>
           <td class="s_out" align="center"><input onclick="c_chang(this)" type="checkbox" value="<?php echo $table['name'];?>" name="select[]" class="checkbox" /></td>
          <td class="catname" align="left"><?php echo $table['name'];?></td>
          <td align="center" class="catid"><?php echo $table['count'];?></td>
          <td align="center" class="catid"><?php echo ceil($table['size']/1024);?>K</td>
        </tr>
       <?php } ?>
...
<?php echo form::select('bagsize',0,array(0=>'请选择分卷大小...',1=>'1M',2=>'2M',5=>'5M',10=>'10M'));?>

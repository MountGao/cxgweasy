...
<input class="btn btn-primary" type="button" value=" 添加投票 " onclick="javascript:window.location.href='<?php echo $base_url;?>/index.php?case=table&act=add&table=ballot&admin_dir=<?php echo get('admin_dir');?>&site=default'" />
...
foreach($data as $d) { ?>
    <tr>
      ...
      <td class="catname" align="left"><?php echo cut($d['title']);?></td>
      <td class="catid" align="center"><?php echo cut($d['num']);?></td>

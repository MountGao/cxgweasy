...
<a href="<?php echo $base_url;?>/index.php?case=table&act=add&table=user&admin_dir=<?php echo get('admin_dir');?>&site=default" class="btn btn-primary">添加用户</a>
...
<td align="center" class="catid"><?php echo cut($d['userid']);?></td>
<td align="center" class="catname"><?php echo cut($d['username']);?></td>
<td align="center" class="catid"><?php echo cut($d['nickname']);?></td>
<td align="center" class="catid"><?php echo usergroupname($d['groupid']);?></td>

<td align="center" class="manage">
<a href="<?php echo modify("act/edit/table/$table/id/$d[$primary_key]");?>">编辑</a>
<?php if($d['isblock']) { ?><a href="<?php echo modify("act/block/table/$table/id/$d[$primary_key]");?>">解冻</a>
<?php } else { ?>

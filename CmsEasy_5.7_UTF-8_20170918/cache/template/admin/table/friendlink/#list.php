...
<a href="<?php echo $base_url;?>/index.php?case=table&act=add&table=friendlink&admin_dir=<?php echo get('admin_dir');?>&site=default" class="btn btn-steeblue">添加友情链接</a>
<a href="<?php echo $base_url;?>/index.php?case=table&act=setting&table=friendlink&admin_dir=<?php echo get('admin_dir');?>&site=default" class="btn btn-lightslategray">友情链接配置</a>
...
<td align="left" class="catname"><?php echo cut($d['name']);?></td>
<td align="center" class="htmldir"><?php echo cut($d['listorder']);?></td>
<td align="center" class="htmldir"><?php if($d['logo']) { ?><?php if($d['logo']) echo helper::img($d['logo'], 100); ?><?php } else { ?>无<?php } ?></td>
<td align="left" class="htmldir"><?php echo cut($d['username']);?></td>
<td align="center" class="htmldir"><?php echo cut($d['adddate']);?></td>

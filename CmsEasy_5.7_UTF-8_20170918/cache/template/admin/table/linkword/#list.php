...
<input title="增加内链" onclick="window.location.href='<?php echo url::create('table/add/table/linkword');?>'" type="button" name="addcontentlinkword" class="btn btn-steeblue" value="增加内链" />
...
<td align="center" class="catid"><?php echo cut($d['id']);?></td>
<td align="left" class="htmldir"><?php echo cut($d['linkword']);?></td>
<td align="left" class="htmldir"><?php echo $d['linkurl'];?></td>
<td class="catid" align="center"><?php echo cut($d['linkorder']);?></td>
<td class="catid" align="center"><?php echo cut($d['linktimes']);?></td>

...
<a href="<?php echo $base_url;?>/index.php?case=table&act=add&table=usergroup&admin_dir=<?php echo get('admin_dir');?>&site=default" class="btn btn-primary">添加用户组</a>
...
<td align="center"><?php echo cut($d['groupid']);?></td>
<td align="center"><?php echo cut($d['groupid']);?></td>

...
<td align="center" ><?php echo $d['bot'];?></td>
<td align="center"><?php echo $d['ip'];?></td>
<td align="center"><?php echo $d['time'];?></td>
<td align="left" style="padding-left:10px;"><a href="<?php echo $d['url'];?>" target="_blank"><?php echo $d['url'];?></a></td>

...
<td class="htmldir" align="center" ><?php echo $d['inviteid'];?></td>
<td align="center" class="catname"><?php echo $d['invitecode'];?></td>
<td class="htmldir" align="center"><?php echo $d['ctname'];?></td>
<td class="htmldir" align="center"><?php echo $d['cttime'];?></td>
<td align="center" class="catname"><?php echo $d['regname'];?></td>
<td class="htmldir" align="center"><?php echo $d['regtime'];?></td>

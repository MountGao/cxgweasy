...
<li class="active"><a href="<?php echo $base_url;?>/index.php?case=union&act=pay&table=union&admin_dir=<?php echo get('admin_dir');?>&site=default">结算记录</a></li>
</ul>
...
<td class="catname" align="left"><?php echo $d['username'];?></td>
<td align="center" class="htmldir"><?php echo date('Y-m-d H:i:s',$d['addtime']);?></td>
<td align="center" class="htmldir"><?php echo $d['amount'];?> 元</td>
<td align="center" class="htmldir"><font color="red"><?php echo $d['payaccount'];?></font></td>
<td align="center" class="htmldir"><?php echo $d['inputer'];?></td>

    ...
    function getcols($act) {
        switch ($act) {
            case 'list':
                return '*';
            case 'modify':
                return 'aid,title,subtitle,catid,catid,tag,spid,introduce,introduce_len,description,keyword,image,thumb,content,checked,template,showform,pics,linkto,mtitle,description,keyword,htmlrule,ishtml,province_id,city_id,section_id,attr1,attr2,attr3,adddate'.$this->mycols();
            case 'manage':
